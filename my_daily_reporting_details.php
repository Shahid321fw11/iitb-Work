...
// added by shahid :- on 6th dec 2024
$currentuser = $_SESSION["ldap"]; // Automatically use the logged-in user's ID
                    ...
                    <form name="submituser" method="post" id="submituser">
                        <table width="80%" align="center" border="0">
                            <tr>
                                ...
                                <td>
                                    <input type="submit" name="searchuser" id="searchuser" value="Submit" onclick="return validateUser2();" />
                                </td>
                            </tr>
