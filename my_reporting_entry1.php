                                ...
                                <tr>
                                    ...
                                    <td align="center" valign="top" style="font-size: large;">
                                        ...
                                        if ($score_data['score'] == '0') {
                                            // If the score is '0', show disabled thumbs-up and thumbs-down
                                        ?>
                                            ...
                                            // If the score is not '0', display the thumbs-up/thumbs-down icon based on the score value
                                            if ($score_data['score'] > 0) {
                                                // If the score is positive, show thumbs-up
                                            ?>
                                                <span>👍</span>
                                            <?php
                                            } elseif ($score_data['score'] < 0) {
                                                // If the score is negative, show thumbs-down
                                            ?>
                                                <span>👎</span>
                                        <?php
                                            }
